...
export function useSmartForm(options: SmartFormOptions): SmartFormReturn {
  ...
  const validateWithAI = async (field: string, value: any): Promise<boolean> => {
    ...
    try {
      console.log('SmartForm - Validating field with AI:', field, value);
      console.log('SmartForm - Using client:', client);
      ...
      console.log('SmartForm - Validation prompt:', prompt);
      ...
      console.log('SmartForm - Validation response:', response);
  ...
  const fixWithAI = async (field: string): Promise<void> => {
    ...
    try {
      console.log('SmartForm - Fixing field with AI:', field, value);
      ...
      console.log('SmartForm - Fix prompt:', prompt);
      ...
      console.log('SmartForm - Fix response:', response);
